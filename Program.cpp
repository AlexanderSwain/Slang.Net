...
Slang::Program::Program(Slang::EntryPoint* entryPoint)
{
...
SlangResult Slang::Program::GetCompiled(const char** output)
{
...
slang::IComponentType* Slang::Program::getNative()
{
    return m_program;
}

slang::IComponentType* Slang::Program::getLinked()
{
    return m_linkedProgram;
}

Slang::EntryPoint* Slang::Program::getEntryPoint()
{
    return m_entryPoint;
}

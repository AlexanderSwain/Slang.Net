...
{
	// Return a fresh wrapper without caching
	slang::TypeReflection* nativeArgumentType = m_native->getArgumentType(index);
	return nativeArgumentType ? new TypeReflection(nativeArgumentType) : nullptr;
}
